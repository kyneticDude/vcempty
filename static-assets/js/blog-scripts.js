...
(function($) { "use strict";
        ...
        $('#get-started-modal').submit(function (e) {
            ...
            let hrefURL = "https://velocityclub.typeform.com/to/pWD8B6d6?source=website&email=" + email.val() + "&name=" + name.val() + "&surname=" + surname.val() + "&cellphone=" + cell.val() + "&_subject=sign_up&_page=Blog_post";
